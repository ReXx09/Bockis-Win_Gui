...
Export-ModuleMember -Function Initialize-LibreHardwareMonitor, Initialize-LiveMonitoring, `
    ...
    Initialize-SMBusAccess, Get-RamTemperatureViaSMBus, Show-HardwareStatsTable
...
function Show-HardwareStatsTable {
    ...
    $dataGridView.BackgroundColor = [System.Drawing.Color]::FromArgb(50, 50, 55)
    $dataGridView.ForeColor = [System.Drawing.Color]::Black
    $dataGridView.GridColor = [System.Drawing.Color]::FromArgb(70, 70, 75)
    ...
    $dataGridView.AlternatingRowsDefaultCellStyle.BackColor = [System.Drawing.Color]::FromArgb(60, 60, 65)
    $dataGridView.DefaultCellStyle.BackColor = [System.Drawing.Color]::FromArgb(70, 70, 75)
    $dataGridView.DefaultCellStyle.ForeColor = [System.Drawing.Color]::White
    $dataGridView.DefaultCellStyle.SelectionBackColor = [System.Drawing.Color]::FromArgb(80, 80, 85)
    $dataGridView.DefaultCellStyle.SelectionForeColor = [System.Drawing.Color]::White
    $dataGridView.ColumnHeadersDefaultCellStyle.BackColor = [System.Drawing.Color]::FromArgb(50, 50, 55)
    ...
    foreach ($key in $stats.Keys) {
        ...
        if ($key -eq "Temp" -or $key -eq "Load") {
            ...
            if ($entry.Last -ge $thresholds[1]) {
                $row.Cells["Current"].Style.BackColor = [System.Drawing.Color]::FromArgb(255, 100, 100)  # Rot
                $row.Cells["Current"].Style.ForeColor = [System.Drawing.Color]::White
            }
            elseif ($entry.Last -ge $thresholds[0]) {
                $row.Cells["Current"].Style.BackColor = [System.Drawing.Color]::FromArgb(255, 200, 100)  # Orange
                $row.Cells["Current"].Style.ForeColor = [System.Drawing.Color]::Black
            }
            else {
                $row.Cells["Current"].Style.BackColor = [System.Drawing.Color]::FromArgb(100, 200, 100)  # Grün
                $row.Cells["Current"].Style.ForeColor = [System.Drawing.Color]::Black
            }
            
            # Max-Wert Farbkodierung
            if ($entry.Max -ge $thresholds[1]) {
                $row.Cells["Max"].Style.BackColor = [System.Drawing.Color]::FromArgb(255, 100, 100)  # Rot
                $row.Cells["Max"].Style.ForeColor = [System.Drawing.Color]::White
            }
            elseif ($entry.Max -ge $thresholds[0]) {
                $row.Cells["Max"].Style.BackColor = [System.Drawing.Color]::FromArgb(255, 200, 100)  # Orange
