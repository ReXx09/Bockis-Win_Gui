...
function Invoke-SmartRepair {
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 1 -Total 22 -Name "Windows Update wird geprüft…" }
    Write-SR "[ 1 / 22 ]  Windows Update Status" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 2 -Total 22 -Name "Defender-Status wird geprüft…" }
    Write-SR "[ 2 / 22 ]  Windows Defender Status" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 3 -Total 22 -Name "System-Integrität wird analysiert…" }
    Write-SR "[ 3 / 22 ]  System-Integrität (CBS-Log Analyse)" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 4 -Total 22 -Name "Ereignisprotokoll wird geprüft…" }
    Write-SR "[ 4 / 22 ]  Ereignisprotokoll (letzte 24 Stunden)" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 5 -Total 22 -Name "Netzwerk-Verbindung wird geprüft…" }
    Write-SR "[ 5 / 22 ]  Netzwerk / Internetverbindung" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 6 -Total 22 -Name "Temporäre Dateien werden bereinigt…" }
    Write-SR "[ 6 / 22 ]  Temp-Cleanup" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 7 -Total 22 -Name "Neustart-Status wird ermittelt…" }
    Write-SR "[ 7 / 22 ]  Neustart-Empfehlung" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 8 -Total 22 -Name "Festplatten-Speicherplatz wird geprüft…" }
    Write-SR "[ 8 / 22 ]  Festplatten-Speicherplatz (C:)" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 10 -Total 22 -Name "Kritische Dienste werden geprüft…" }
    Write-SR "[ 10 / 22 ]  Kritische Windows-Dienste" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 11 -Total 22 -Name "Windows-Aktivierung wird geprüft…" }
    Write-SR "[ 11 / 22 ]  Windows-Aktivierungsstatus" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 12 -Total 22 -Name "Festplatten-Gesundheit (SMART) wird geprüft…" }
    Write-SR "[ 12 / 22 ]  Festplatten-Gesundheit (SMART)" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 13 -Total 22 -Name "Systemzeit-Synchronisation wird geprüft…" }
    Write-SR "[ 13 / 22 ]  Systemzeit-Synchronisation" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 14 -Total 22 -Name "RAM-Auslastung wird ermittelt…" }
    Write-SR "[ 14 / 22 ]  RAM-Auslastung" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 15 -Total 22 -Name "Hosts-Datei wird geprüft…" }
    Write-SR "[ 15 / 22 ]  Hosts-Datei-Integrität" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 16 -Total 22 -Name "DISM Component-Store wird geprüft…" }
    Write-SR "[ 16 / 22 ]  DISM Component-Store (CheckHealth)" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 18 -Total 22 -Name "Auslagerungsdatei wird geprüft…" }
    Write-SR "[ 18 / 22 ]  Auslagerungsdatei (Pagefile)" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 20 -Total 22 -Name "Zertifikatsspeicher wird geprüft…" }
    Write-SR "[ 20 / 22 ]  Root-Zertifikate (Gültigkeit)" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 21 -Total 22 -Name "Energieplan wird geprüft…" }
    Write-SR "[ 21 / 22 ]  Energieplan" "Header"
    ...
    # =========================================================================
    if ($ProgressCallback) { & $ProgressCallback -Step 22 -Total 22 -Name "Windows-Suchdienst wird geprüft…" }
    Write-SR "[ 22 / 22 ]  Windows-Suchdienst (WSearch)" "Header"
