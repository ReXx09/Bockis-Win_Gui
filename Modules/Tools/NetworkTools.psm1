...
function Start-PingTest {
    ...
    Write-ToolLog -ToolName "NetworkTools" -Message "Ping-Test wird gestartet" -OutputBox $outputBox -Color ([System.Drawing.Color]::Blue) -Level "Information" -SaveToDatabase
    ...
    if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
        ...
        try {
            ...
            if ($successRate -eq 100) {
                ...
                Write-ToolLog -ToolName "NetworkTools" -Message $message -OutputBox $null -Color ([System.Drawing.Color]::Green) -Level "Success" -SaveToDatabase
            ...
            elseif ($successRate -ge 25) {
                ...
                $outputBox.AppendText("$message`r`n")
                Write-ToolLog -ToolName "NetworkTools" -Message $message -OutputBox $null -Color ([System.Drawing.Color]::Yellow) -Level "Warning" -SaveToDatabase
                # Auch in der PowerShell-Konsole anzeigen
                ...
                $outputBox.AppendText("$message`r`n")
                Write-ToolLog -ToolName "NetworkTools" -Message $message -OutputBox $null -Color ([System.Drawing.Color]::Red) -Level "Error" -SaveToDatabase
                # Auch in der PowerShell-Konsole anzeigen
            ...
            Write-ToolLog -ToolName "NetworkTools" -Message "Fehler beim Ping-Test: $($_.Exception.Message)" -OutputBox $null -Color ([System.Drawing.Color]::Red) -Level "Error" -SaveToDatabase
        }
...
function Restart-NetworkAdapter {
    ...
    # Log-Eintrag erstellen
    Write-ToolLog -ToolName "NetworkTools" -Message "Start der Netzwerkadapter-Zurücksetzung" -OutputBox $outputBox -Color ([System.Drawing.Color]::Blue) -Level "Information" -SaveToDatabase
    ...
    if ($result -eq "OK") {
        ...
        try {
            ...
            Write-ToolLog -ToolName "NetworkTools" -Message "Netzwerkadapter wurden erfolgreich zurückgesetzt" -OutputBox $null -Color ([System.Drawing.Color]::Green) -Level "Success" -SaveToDatabase
        }
        catch {
            $outputBox.SelectionColor = [System.Drawing.Color]::Red
            ...
            # Log-Eintrag für Fehler
            Write-ToolLog -ToolName "NetworkTools" -Message "Fehler beim Zurücksetzen der Netzwerkadapter: $($_.Exception.Message)" -OutputBox $null -Color ([System.Drawing.Color]::Red) -Level "Error" -SaveToDatabase
        }
